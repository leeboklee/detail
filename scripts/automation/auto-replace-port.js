...
// 환경변수에서 포트 가져오기, 기본값 3900
const TARGET_PORT = process.env.PORT || '3900';
const REPLACE_EXPR = process.env.PORT || '3900';
const FILE_EXT = '.js';
const EXCLUDE_DIRS = [
...
function replaceInFile(filePath) {
  ...
  // 3900을 3900으로 교체
  const newContent = content.replace(/3900/g, TARGET_PORT);
