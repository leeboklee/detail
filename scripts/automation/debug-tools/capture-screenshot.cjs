...
program
  .option('-u, --url <url>', 'URL to capture', 'http://localhost:3900')
  .option('-o, --output <path>', 'Output image path', 'screenshot.png')
  .option('-w, --width <width>', 'Viewport width', '1920')
  .option('-h, --height <height>', 'Viewport height', '1080')
  .option('-d, --delay <delay>', 'Delay in ms before capture', '0');
